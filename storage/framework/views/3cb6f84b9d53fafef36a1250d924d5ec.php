...
<div class="content">
	<div class="page-header">
		...
		<div class="page-btn">
			<a href="<?php echo e(route('products.create')); ?>" class="btn btn-primary btn_modal"><i class="ti ti-circle-plus me-1"></i>Add Product</a>
		</div>
	</div>
	<!-- /product list -->
	<div class="card">
            ...
            <div class="col-12">
                <div class="d-flex flex-wrap gap-2 p-2">
                    ...
                    <a class="btn btn-sm btn-info show_update"
                       href="<?php echo e(route('productUpdate')); ?>?is_ecom=1">
                        Ecom Active
                    </a>
                    <a class="btn btn-sm btn-danger show_update"
                       href="<?php echo e(route('productUpdate')); ?>?is_ecom=0">
                        Ecom De-Active
                    </a>
    
                    <a class="btn btn-sm btn-info show_update"
                       href="<?php echo e(route('productUpdate')); ?>?is_feature=1">
                        Active (Feature)
                    </a>
                    <a class="btn btn-sm btn-danger show_update"
                       href="<?php echo e(route('productUpdate')); ?>?is_feature=0">
                        De-active (Feature)
                    </a>
    
                    <a class="btn btn-sm btn-info show_update"
                       href="<?php echo e(route('productUpdate')); ?>?is_reco=1">
                        Active (Trending)
                    </a>
                    <a class="btn btn-sm btn-danger show_update"
                       href="<?php echo e(route('productUpdate')); ?>?is_reco=0">
                        De-active (Trending)
                    </a>
                     <a href="<?php echo e(route('product.created.history')); ?>" class="btn btn-sm btn-info btn_modal"><i class="ti ti-eye me-1"></i>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    function getData(page=null){
        ...
        $('#member_data').html('');
        $.ajax({
            url: '<?php echo e(route("products.index")); ?>?page='+page,
            type: 'GET',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\personal\as-multi-vendor-ecom\admin\resources\views/products/index.blade.php ENDPATH**/ ?>