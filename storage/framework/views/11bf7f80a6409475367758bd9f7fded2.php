<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(getImage('favicon', getInfo('favicon'))); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/owlcarousel/owl.theme.default.min.css')); ?>">
    ...
    <!-- Color Picker Css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/%40simonwep/pickr/themes/nano.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.css">

    <!-- Main CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/pos_style.css')); ?>">
...
</head><?php /**PATH E:\laragon\www\personal\as-multi-vendor-ecom\admin\resources\views/partials/head.blade.php ENDPATH**/ ?>