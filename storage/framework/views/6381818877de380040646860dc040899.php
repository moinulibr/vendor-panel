  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="summary-card">
            ...
            <h3><?php echo e(number_format($totalCreatedProducts)); ?></h3>
        </div>
          ...
          <div class="table-responsive history-container">
            <table class="table table-hover align-middle mb-0 custom-history-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $productHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="px-4 fw-medium text-dark">
                            <?php echo e(\Carbon\Carbon::parse($history->date)->format('d-m-Y')); ?>

                        </td>
                        <td class="text-center ">
                            <span class="count-badge shadow-sm status-indicator"><?php echo e($history->total); ?></span>
                        </td>
                        <td class="text-end px-4">
                            <span>
                              <?php echo e(\Carbon\Carbon::parse($history->date)->format('D, d M Y')); ?>
...
</div><?php /**PATH E:\laragon\www\personal\as-multi-vendor-ecom\admin\resources\views/products/createdHistory.blade.php ENDPATH**/ ?>