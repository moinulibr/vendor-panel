    ...
    <div class="main-wrapper">
        ...
        <div class="sidebar no-print" id="sidebar">
            ...
            <div class="modern-profile p-3 pb-0">
                <div class="text-center rounded bg-light p-3 mb-4 user-profile">
                    <div class="avatar avatar-lg online mb-3">
                        <img src="<?php echo e(asset('assets/img/customer/customer15.jpg')); ?>" alt="Img" class="img-fluid rounded-circle">
                    </div>
            ...
            <div class="sidebar-header p-3 pb-0 pt-2">
                ...
                <div class="d-flex align-items-center justify-content-between menu-item mb-3">
                    <div>
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-sm btn-icon bg-light">
        ...
        <div class="page-wrapper">
            ...
            <div class="copyright-footer d-flex align-items-center justify-content-between border-top bg-white gap-3 flex-wrap no-print">
                <p class="fs-13 text-gray-9 mb-0">2025 &copy; <?php echo e(getInfo('title')); ?>. All Right Reserved</p>
...
</html><?php /**PATH E:\laragon\www\personal\as-multi-vendor-ecom\admin\resources\views/layouts/app.blade.php ENDPATH**/ ?>