...
interface ProductApiDocInterface
{
    #[OA\Get(
        ...
        description: "Fetch paginated products with multi-category, brand, vendor, search, user_base_id filters.",
        tags: ["Product"],
        security: [["sanctum" => []]],
        parameters: [
    ...
    #[OA\Get(
        path: "/api/v1/app/check-stock-quantity/{identifier}",
    ...
    public function checkStockQuantity(ProductStockCheckRequest $request, string|int $identifier);
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: "user_base_id", description: "When the logged-in user is a SR, they will act as a Dealer or an Exclusive client by passing their respective user_base_id.", type: "integer", example: 1, nullable: true),
