...
class PermissionController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax()){
            ...
            return view('permissions.data',compact('items'));
        }
    ...
    public function store(Request $request){
        ...
        return response()->json(['status'=>true ,'msg'=>'Permission Created !!','function'=>'getData']);
    }
    ...
    public function update(Request $request, Permission $permission){
        ...
        return response()->json(['status'=>true ,'msg'=>'Permission Updated !!','function'=>'getData']);
    }
