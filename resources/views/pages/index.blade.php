...
<div class="content">
	<div class="page-header">
		...
		<div class="page-btn">
			<a href="{{ route('pages.create')}}" class="btn btn-primary btn_modal"><i class="ti ti-circle-plus me-1"></i>Add Page</a>
		</div>
	</div>
	<!-- /product list -->
	<div class="card">
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    function getData(page=null){
        ...
        $('#member_data').html('');
        $.ajax({
            url: '{{ route("pages.index")}}?page='+page,
            type: 'GET',
            data:{q,status,sort},
            dataType: 'html',
