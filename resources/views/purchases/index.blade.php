...
<div class="content">
	<div class="page-header">
		...
		<!--</ul>-->
		<div class="page-btn">
			<a href="{{ route('purchases.create')}}" class="btn btn-primary btn_modal"><i class="ti ti-circle-plus me-1"></i>Add Purchase</a>
		</div>
	</div>
	<!-- /product list -->
            ...
            <div class="d-flex align-items-end flex-wrap gap-3">
                ...
                <div class="supplier-wrapper">
                  <div class="form-group mb-0">
                    ...
                    <select class="form-control w-100" id="contact_id">
...
<script type="text/javascript">
    ...
    $(document).on('blur',".quantity, .unit_price, .shipping_charge",function(e) {
    ...
    function calculateSum() {
        ...
        let charge=Number($('input.shipping_charge').val() || 0);
        let sub_total=charge;
