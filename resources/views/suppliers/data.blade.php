<div class="table-responsive">
	<table class="table ">
		...
		<tbody>
			...
			@php
			    $due=$item->total_purchase - $item->total_purchase_paid;
			@endphp
			<tr>
			    <td>
			        {{ $i+1}}
			    ...
			    <td class="action-table-data">
                    <div class="dropdown action-dropdown-wrap">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end action-dropdown">
                            ...
                            <li>
                                <a class="dropdown-item btn_modal" href="{{ route('contacts.edit',[$item->id])}}">
                            ...
                            <li>
                                <a class="dropdown-item text-danger delete" href="{{ route('contacts.destroy',[$item->id])}}">
				...
				<td>{{ priceFormate($item->total_purchase)}}</td>
				<td>{{ priceFormate($item->total_purchase_paid ??0)}}</td>
