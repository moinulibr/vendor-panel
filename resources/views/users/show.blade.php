	...
	<div class="card">
		...
		<div class="card-body profile-body">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-sm-12">
					<div class="mb-3">
						<label class="form-label">Trade License <span class="text-danger ms-1">*</span></label>
						<input type="text" value="{{ $vendor->trade_license??''}}" name="trade_license" class="form-control">
					</div>
				</div>
				
				<div class="col-lg-6 col-sm-12">
					<div class="mb-3">
						<label class="form-label"> Fax <span class="text-danger ms-1">*</span></label>
						<input type="text" value="{{ $vendor->fax??''}}" name="fax" class="form-control">
					</div>
				</div>
				...
				<!--<div class="col-lg-6 col-sm-12 hide">-->
				<!--	<div class="mb-3">-->
