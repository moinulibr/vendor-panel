				...
				<td>
					<div class="d-flex align-items-center">
						<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
							<img class="object-fit-contain" src="{{ getImage('brands',$item->image)}}" alt="img">
						</a>
				...
				<td class="action-table-data">
                    <div class="dropdown action-dropdown-wrap">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end action-dropdown">
                            @can('brands.edit')
                            <li>
                                <a class="dropdown-item btn_modal" href="{{ route('brands.edit',[$item->id])}}">
                            ...
                            @can('brands.delete')
                            <li>
                                <a class="dropdown-item text-danger delete" href="{{ route('brands.destroy',[$item->id])}}">
