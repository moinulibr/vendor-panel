...
<div class="content">
	<div class="page-header">
        ...
        @can('incomes.create')
		<div class="page-btn">
			<a href="{{ route('transaction_categories.create',['type'=>'income'])}}" class="btn btn-primary btn_modal"><i class="ti ti-circle-plus me-1"></i>Add Category</a>
		</div>
		@endcan
	</div>
	<!-- /product list -->
  ...
  $(document).ready(function () {
    ...
    function getData(page=null){
        ...
        $.ajax({
            ...
            type: 'GET',
            data:{q,status,sort,type:'income'},
            dataType: 'html',
