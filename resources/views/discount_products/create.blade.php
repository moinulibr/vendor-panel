<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <form action="{{ route('discount_products.update',[$discount->id])}}" method="post" id="ajax_form">
    @method('PATCH')
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-12 my-3">
                <div class="form-group">
                    ...
                    <select id="product_select" name="product_id[]" multiple="multiple" style="width:100%" required>
