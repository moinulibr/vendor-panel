        ...
        <div class="card-body pb-2">
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                    ...
                    <select class="form-select" id="order_from_id">
                        <option value="">All</option>
                        @foreach($order_froms as $order_from)
                            <option value="{{ $order_from->id }}">
                                {{ $order_from->title }}
                            </option>
                        @endforeach
                    </select>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    $('#type_id, #shipping_status, #payment_status, #order_from_id').change(function(){
        getData();
    });
    ...
    function getData(page=null){
        ...
        let order_from_id=$('#order_from_id').val();
        let is_pos=1;
        ...
        $.ajax({
            ...
            type: 'GET',
            data:{q,date,type_id,is_pos,shipping_status, payment_status, order_from_id},
            dataType: 'html',
