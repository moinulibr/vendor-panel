			    ...
			    <td class="action-table-data">
                    <div class="dropdown action-dropdown-wrap">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end action-dropdown">
                            <li>
                                <a class="dropdown-item btn_modal" href="{{ route('expenses.show',[$item->id])}}">
                                    <i class="fa fa-eye"></i>
                                    <span>View</span>
                                </a>
                            </li>
                            ...
                            @can('expenses.edit')
                            <li>
                                <a class="dropdown-item btn_modal" href="{{ route('expenses.edit',[$item->id])}}">
                                    <i class="fa fa-edit"></i>
                                    <span>Edit</span>
                                </a>
                            </li>
                            ...
                            @can('expenses.delete')
                            <li>
                                <a class="dropdown-item text-danger delete" href="{{ route('expenses.destroy',[$item->id])}}">
