...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel"> Payment {{$item->type}} #{{$item->invoice_no}}  Total Due: <span class="total_due_amount">{{ $due}}</span></h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form action="{{route('transaction_payments.update',[$item->id])}}" method="POST" id="ajax_form">
                @csrf
                @method('PATCH')
                <div class="row">
                ...
                <div class="mb-3">
                    <label class="form-label">Payment Type</label>
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" class="form-control mb-2 pay_amount {{$class}}"
                        ...
                        <div class="col-sm-12 next_payment_wrapper" style="display: none;">
                            <div class="form-group">
                                <label> Next Payment Date </label>
                                <input type="date" name="next_payment_date" value="" class="form-control next_payment_date">
                            </div>
                        </div>
