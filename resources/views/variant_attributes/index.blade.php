...
<div class="content">
	<div class="page-header">
	    ...
	    @can('variants.create')
		<div class="page-btn">
			<a href="{{ route('variant_attributes.create')}}" class="btn btn-primary btn_modal"><i class="ti ti-circle-plus me-1"></i>Add Variant</a>
		</div>
		@endcan
	</div>
	<!-- /product list -->
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    function getData(page=null){
        ...
        $('#member_data').html('');
        $.ajax({
            url: '{{ route("variant_attributes.index")}}?page='+page,
            type: 'GET',
            data:{q,status},
            dataType: 'html',
